...
namespace FinalProject
{
    public partial class ucListEmpMonth : UserControl
    {
        ...
        {
            rpListEmpMonth rpLEM = new rpListEmpMonth(dateEdit1.DateTime);
            rpLEM.DataSource = dt;
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string sql = "select EmployeesID, Date, TimeIn, TimeOut from TimeWorking where Month(Date)='" + dateEdit1.DateTime.Month + "'";
